 ...
 * their original order, but with no duplicates in the final array. The unique
 * numbers should be sorted by their original order, but the final array should
...
function uniteUnique(...arr) {
  ...
  allArrays = allArrays.flat()

  allArrays.forEach(num => {
